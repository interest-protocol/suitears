...
module suitears::fixed_point_wad {
    ...
    public fun exp(x: Int): Int {
        ...
        int::from_u256(
            (int::to_u256(r) * 3822833074963236453042738258902158003155416615667) >> int::to_u8(
                int::sub(int::from_u8(195), k)
            )
        )
    }
    ...
    public fun ln(x: Int): Int {
        ...
        r = int::add(
            r,
            int::from_u256(600920179829731861736702779321621459595472258049074101567377883020018308)
        );

 ...
 */
  public fun cast_vote<DaoWitness: drop, CoinType>(
    ...
    emit(CastVote<DaoWitness, CoinType>{
 ...
 */
  public fun change_vote<DaoWitness: drop, CoinType>(
    ...
    emit(ChangeVote<DaoWitness, CoinType>{
      proposal_id, value,
      voter: ctx.sender(),
      end_time: proposal.end_time,
      agree: vote.agree,
  ...
  */
  public fun revoke_vote<DaoWitness: drop, CoinType>(
    ...
    emit(RevokeVote<DaoWitness,  CoinType>{ proposal_id: proposal_id, value, agree: vote.agree, voter: ctx.sender() });
  ...
  */
  public fun unstake_vote<DaoWitness: drop, CoinType>(
    ...
    emit(UnstakeVote<DaoWitness, CoinType>{
      proposal_id,

...
module suitears::farm {
    ...
    public fun new_account<StakeCoin, RewardCoin>(
        ...
        Account { id: object::new(ctx), farm_id: object::id(self), amount: 0, reward_debt: 0 }
    }
     ...
     * @return u64.
     */
    public fun last_reward_timestamp<StakeCoin, RewardCoin>(
        self: &Farm<StakeCoin, RewardCoin>,
    ): u64 {
     ...
     * @return u256.
     */
    public fun accrued_rewards_per_share<StakeCoin, RewardCoin>(
        self: &Farm<StakeCoin, RewardCoin>,
    ): u256 {
     ...
     * @return u64.
     */
    public fun stake_coin_decimal_factor<StakeCoin, RewardCoin>(
        self: &Farm<StakeCoin, RewardCoin>,
    ): u64 {
    ...
    public fun pending_rewards<StakeCoin, RewardCoin>(
        ...
        let accrued_rewards_per_share = if (cond) { farm.accrued_rewards_per_share } else {
    ...
    public fun add_rewards<StakeCoin, RewardCoin>(
        self: &mut Farm<StakeCoin, RewardCoin>,
        c: &Clock,
     ...
     */
    public fun destroy_zero_account<StakeCoin, RewardCoin>(
        account: Account<StakeCoin, RewardCoin>,
    ) {
    ...
    public fun update_rewards_per_second<StakeCoin, RewardCoin>(
        ...
        emit(
            NewRewardRate<StakeCoin, RewardCoin> {
                farm: object::id(farm),
     ...
     */
    public fun destroy_zero_farm<StakeCoin, RewardCoin>(
        farm: Farm<StakeCoin, RewardCoin>,
        cap: &OwnerCap<FarmWitness>,
    ) {
        owner::assert_ownership(cap, object::id(&farm));
        ...
        balance_stake_coin.destroy_zero();
    }
     ...
     * - `cap` does not own the `farm`.
     */
    public fun borrow_mut_uid<StakeCoin, RewardCoin>(
        farm: &mut Farm<StakeCoin, RewardCoin>,
        cap: &OwnerCap<FarmWitness>,
    ): &mut UID {
        owner::assert_ownership(cap, object::id(farm));
    ...
    fun calculate_pending_rewards<StakeCoin, RewardCoin>(
        ...
        (
            (
                (
                    (acc.amount as u256) * accrued_rewards_per_share / (stake_factor as u256),
                ) - acc.reward_debt,
            ) as u64,
        )
    }
    ...
    fun calculate_reward_debt(
        ...
        let mut stake_amount = ((stake_amount as u256), (stake_factor as u256));

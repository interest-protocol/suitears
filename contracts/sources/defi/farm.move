...
module suitears::farm {
  ...
  * @return u64.
  */
  public fun rewards_per_second<StakeCoin, RewardCoin>(
    self: &Farm<StakeCoin, RewardCoin>
  ): u64 {
  ...
  * @return u64.
  */
  public fun start_timestamp<StakeCoin, RewardCoin>(
    self: &Farm<StakeCoin, RewardCoin>
  ): u64 {
  ...
  * @return u64.
  */
  public fun balance_stake_coin<StakeCoin, RewardCoin>(
    self: &Farm<StakeCoin, RewardCoin>
  ): u64 {
  ...
  * @return u64.
  */
  public fun balance_reward_coin<StakeCoin, RewardCoin>(
    self: &Farm<StakeCoin, RewardCoin>
  ): u64 {
  ...
  * @return ID.
  */
  public fun owned_by<StakeCoin, RewardCoin>(
    self: &Farm<StakeCoin, RewardCoin>
  ): ID {
    self.owned_by
  }
  ...
  * @return u64.
  */
  public fun amount<StakeCoin, RewardCoin>(
  ...
  * @return u256.
  */
  public fun reward_debt<StakeCoin, RewardCoin>(
    account: &Account<StakeCoin, RewardCoin>
  ): u256 {
    account.reward_debt
  }
  ...
  */
  public fun stake<StakeCoin, RewardCoin>(
    ...
    emit(Stake<StakeCoin, RewardCoin> {
      farm: object::id(farm),
      stake_amount,
  ...
  */
  public fun unstake<StakeCoin, RewardCoin>(
    ...
    emit(Unstake<StakeCoin, RewardCoin> {
      farm: object::id(farm),

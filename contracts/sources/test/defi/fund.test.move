...
module suitears::fund_tests {
    ...
    fun test_case_one() {
        ...
        let new_shares = math64::mul_div_up(
            1234,
            2468 - shares_burned - 273,
            2468 + profit - 437 - underlying_burned
        );
        ...
        let underlying_burned = math64::mul_div_up(
            387,
            current_underlying - 437,
            current_shares - shares_burned
        );

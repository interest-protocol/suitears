...
module suitears::math128_tests {
    ...
    fun test_try_add() {
        ...
        let mut pred = try_add(MAX_U128, 1);
    ...
    fun test_try_mul() {
        ...
        let mut pred = try_mul((MAX_U128 / 2) + 1, 2);
        assert_eq(pred, false);
        assert_eq(result, 0);
    }
    ...
    fun test_try_mul_div_down() {
        ...
        let mut pred = try_mul_div_down((MAX_U128 / 2) + 1, 2, 4);
        assert_eq(pred, true);
    ...
    fun test_try_mul_div_up() {
        ...
        let mut pred = try_mul_div_up((MAX_U128 / 2) + 1, 2, 4);
        assert_eq(pred, true);
        assert_eq(result, 85070591730234615865843651857942052864);

...
module suitears::fixed_point_wad_tests {
    ...
    fun test_try_mul_down() {
        let mut pred = try_mul_down(WAD * 3, WAD * 5);
        assert_eq(pred, true);
        assert_eq(r, 15 * WAD);

        let mut pred = try_mul_down(WAD * 3, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 45 * WAD / 10);

        let mut pred = try_mul_down(3333333333, 23234567832);
        assert_eq(pred, true);
        assert_eq(r, 77);
        ...
        let mut pred = try_mul_down(0, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 0);

        let mut pred = try_mul_down(MAX_U256, MAX_U256);
    ...
    #[test]
    fun test_try_mul_up() {
        let mut pred = try_mul_up(WAD * 3, WAD * 5);
        assert_eq(pred, true);
        assert_eq(r, 15 * WAD);

        let mut pred = try_mul_up(WAD * 3, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 45 * WAD / 10);
        ...
        let mut pred = try_mul_up(0, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 0);

        let mut pred = try_mul_up(MAX_U256, MAX_U256);
        assert_eq(pred, false);
        assert_eq(r, 0);
    }
    ...
    fun test_try_div_down() {
        let mut pred = try_div_down(WAD * 3, WAD * 5);
        assert_eq(pred, true);
        assert_eq(r, 6 * WAD / 10);

        let mut pred = try_div_down(WAD * 3, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 2 * WAD);
        //    ;
        ...
        let mut pred = try_div_down(0, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 0);
        ...
        let mut pred = try_div_down(MAX_U256, MAX_U256);
        // overflow;
        assert_eq(pred, false);
        assert_eq(r, 0);
    }
    ...
    #[test]
    fun test_try_div_up() {
        let mut pred = try_div_up(WAD * 3, WAD * 5);
        assert_eq(pred, true);
        assert_eq(r, 6 * WAD / 10);

        let mut pred = try_div_up(WAD * 3, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 2 * WAD);
        //    ;
        ...
        let mut pred = try_div_up(0, (WAD / 10) * 15);
        assert_eq(pred, true);
        assert_eq(r, 0);
        ...
        let mut pred = try_div_up(MAX_U256, MAX_U256);
        // overflow;
        assert_eq(pred, false);
        assert_eq(r, 0);
    }

...
module suitears::int_tests {
    ...
    fun test_truncate_to_u16() {
        ...
        assert_eq(
            truncate_to_u16(
                from_u256(1766847064778384329583297500742918515827483896875618958121606201292619776)
            ),
            0
        );
    ...
    fun test_truncate_to_u128() {
        ...
        assert_eq(
            truncate_to_u128(neg_from_u256(987654321098765432109876543210)),
        ...
        assert_eq(
            truncate_to_u128(neg_from_u256(123456789012345678901234567890)),
            340282366797481674451028928530533643566
        );
        assert_eq(
            truncate_to_u128(neg_from_u256(170141183460469231731687303715884105728)),

...
module suitears::vectors_tests {
    ...
    fun test_descending_insertion_sort() {
        assert_eq(descending_insertion_sort(vector[5, 2, 9, 1, 5, 6]), vector[9, 6, 5, 5, 2, 1]);

        assert_eq(descending_insertion_sort(vector[1, 2, 3, 4, 5, 6]), vector[6, 5, 4, 3, 2, 1]);

        assert_eq(descending_insertion_sort(vector[6, 5, 4, 3, 2, 1]), vector[6, 5, 4, 3, 2, 1]);
        ...
        assert_eq(
            descending_insertion_sort(
                vector[12, 23, 4, 5, 2, 34, 1, 43, 54, 32, 45, 6, 7, 8, 9, 10, 21, 20],
            ),
    ...
    fun test_ascending_insertion_sort() {
        assert_eq(ascending_insertion_sort(vector[5, 2, 9, 1, 5, 6]), vector[1, 2, 5, 5, 6, 9]);

        assert_eq(ascending_insertion_sort(vector[1, 2, 3, 4, 5, 6]), vector[1, 2, 3, 4, 5, 6]);

        assert_eq(ascending_insertion_sort(vector[6, 5, 4, 3, 2, 1]), vector[1, 2, 3, 4, 5, 6]);

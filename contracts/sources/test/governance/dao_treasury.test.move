...
module suitears::dao_treasury_tests {
    ...
    fun test_treasury_view_functions() {
        ...
        next_tx(test, alice);
        {
            ...
            dao_treasury::donate<InterestDAO, S_ETH>(
                &mut treasury,
                mint_for_testing(1234, ctx(test)),
                ctx(test)
            );
    ...
    fun test_flash_loan() {
        ...
        next_tx(test, alice);
        {
            ...
            let mut borrowed_coin = dao_treasury::flash_loan<InterestDAO, S_ETH>(
                &mut treasury,
                1234,
                ctx(test)
            );
            ...
            dao_treasury::repay_flash_loan(&mut treasury, receipt, borrowed_coin);
    ...
    fun test_low_flash_loan_repay() {
        ...
        next_tx(test, alice);
        {
            ...
            coin::join(
                &mut borrowed_coin,
                mint_for_testing((1234 * FLASH_LOAN_FEE / 1_000_000_000), ctx(test))
            );
